object Main {
  ...
  val within = (diff: Int) => (value: Int, value2: Int) => Math.abs(value - value2) == diff //
  ...
  def main(args: Array[String]) {
    ...
    csp.addConstraint(Milk, Milk, (var1, var2) => var1 == 3)
    csp.addConstraint(Norwegian, Norwegian, (var1, var2) => var1 == 1)
